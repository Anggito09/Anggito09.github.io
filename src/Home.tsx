...
export default function Home() {
  ...
  return <main>
    ...
    <section id="cara" className="section wrap" data-reveal><div className="center"><span className="eyebrow coral">GAMPANG BANGET</span><h2>3 langkah, langsung jepret</h2></div><div className="steps"><article><span>01</span><div aria-hidden="true" className="step-icon camera-icon"></div><h3>Pilih kamera</h3><p>Tentukan kamera, durasi, dan kebutuhan paper.</p></article><article><span>02</span><div aria-hidden="true" className="step-icon chat-icon"></div><h3>Konfirmasi jadwal</h3><p>Chat WhatsApp untuk cek unit dan lokasi serah terima.</p></article><article><span>03</span><div aria-hidden="true" className="step-icon moment-icon"></div><h3>Ambil & abadikan</h3><p>Terima unit bersih beserta tutorial singkatnya.</p></article></div></section>
